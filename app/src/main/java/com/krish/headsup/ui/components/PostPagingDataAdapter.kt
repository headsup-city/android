...
class PostPagingDataAdapter(private val onCommentClickListener: PostView.OnCommentClickListener, private val onAuthorClickListener: PostView.OnAuthorClickListener, private val likeButtonClickListener: PostView.OnLikeButtonClickListener, private val lifecycleOwner: LifecycleOwner, private val sharedViewModel: SharedViewModel) :
